  ...
  return (
    <div className="mt-[3.125rem]">
      <div className="flex justify-between items-start gap-12 sm:gap-0">
        ...
        <p className="w-auto sm:w-[47%] text-[0.625rem] sm:text-sm md:text-xl lg:text-[1.4375rem] font-medium leading-[13px] md:leading-[30px] whitespace-pre-line text-justify tracking-[-0.03em]">{description}</p>
      </div>
    </div>
  );
};
