    ...
    <section className="text-secondary">
      <div className="hidden md:flex justify-between items-start">
        <div className="w-[50%] self-stretch relative"> {/* pt-[1.875rem] */}
          <p className="max-w-[570px] text-[10px] sm:text-[1.4375rem] leading-[13px] sm:leading-[26.45px] font-medium whitespace-pre-line tracking-tight text-justify">{type1Data.title1}</p>
