    ...
    <section className="text-secondary">
      <div className="flex justify-between items-start">
        <div className="w-[50%] self-stretch relative"> {/* pt-[1.875rem] */}
          <p className="text-[10px] sm:text-[23px] leading-[10px] sm:leading-[26.45px] font-medium whitespace-normal md:whitespace-pre-line tracking-tight">{type1Data.title1}</p>
      ...
      {type1Data.widthTitle2 && (
        <div className={`mt-5 sm:mt-[3.125rem] ${type1Data.widthTitle2} sm:ml-auto text-xs sm:text-[23px] leading-[13px] sm:leading-[26.45px] font-medium`}>
          {type1Data.title2}
        </div>
      )}
    </section>
