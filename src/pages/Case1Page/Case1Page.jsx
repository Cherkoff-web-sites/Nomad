...
const Case1Page = () => {
  ...
  const type1Data = {
    title1: 'Прототипом цифрового маскота стал тот самый \nреальный бык прямиком из Московского \n зоопарка — Гаврюша.',
    title2:
  ...
  return (
    <main className="container mx-auto">
      ...
      <NextPrevCase dataPrev={casesData[0]} dataNext={casesData[17]} link={"/case18"} check={true}/>
