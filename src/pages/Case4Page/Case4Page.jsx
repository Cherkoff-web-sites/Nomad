  ...
  return (
    <>
      <main className="container mx-auto">
        ...
        {/* Section 2 */}
        <HalfText 
          title={'Вместо привычных официальных форматов и стандартной застройки в экспоцентре мы предложили другой подход — живой, визуально привлекательный маркет, формат которого был близок и понятен целевой аудитории, но абсолютно новым для сферы представления застройщиков. Так и родилась концепция «Жилищный БАЗАР».'}
        />
