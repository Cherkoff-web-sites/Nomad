  ...
  return (
    <>
      <main className="container mx-auto">
        ...
        {/* Section 4 */}
        <img src={image2} alt="image_2" className="mt-5 md:mt-[20px]" loading='lazy'/>
        ...
        {/* Section 7 */}
        <img src={image7} alt="image_7" className="mt-5 md:mt-[20px]" loading='lazy'/>
        ...
        {/* Section 9 */}
        <img src={image8} alt="image_8" className="mt-5 md:mt-[20px]" loading='lazy'/>
        ...
        {/* Section 12 */}
        <img src={image11} alt="image_11" className="mt-5 md:mt-[20px]" loading='lazy'/>

        {/* Section 13 */}
        <img src={image12} alt="image_12" className="mt-5 md:mt-[20px]" loading='lazy'/>
